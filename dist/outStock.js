...
var OutStock = function (_Component) {
    ...
    function OutStock(props) {
        ...
        _this2.getData = function () {
            ...
            AJAX.AJAX('http://106.12.194.98/api/goods/reduce/history?date_start=' + DATE.getDate('day', '-') + '&date_end=' + DATE.getDate('day', '-'), 'GET', false, head, _this2.isLogin, _this2.error);
        };
